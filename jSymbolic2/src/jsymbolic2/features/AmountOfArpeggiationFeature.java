		...
		extends MIDIFeatureExtractor
{
	...
	throws Exception
	{
		...
		{
			value =   sequence_info.getMelodic_interval_histogram()[0]
					+ sequence_info.getMelodic_interval_histogram()[3]
					+ sequence_info.getMelodic_interval_histogram()[4]
					+ sequence_info.getMelodic_interval_histogram()[7]
					+ sequence_info.getMelodic_interval_histogram()[10]
					+ sequence_info.getMelodic_interval_histogram()[11]
					+ sequence_info.getMelodic_interval_histogram()[12]
					+ sequence_info.getMelodic_interval_histogram()[15]
					+ sequence_info.getMelodic_interval_histogram()[16];
		}
		else value = -1.0;
