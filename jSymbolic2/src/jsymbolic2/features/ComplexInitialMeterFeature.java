...
public class ComplexInitialMeterFeature
    ...
    public double[] extractFeature(Sequence sequence,
        ...
        if (null != sequence_info) {
            ...
            if (5.0 == initial_time_signature_numerator || 7.0 == initial_time_signature_numerator ||
                    9.0 == initial_time_signature_numerator || 11.0 == initial_time_signature_numerator ||
                    13.0 == initial_time_signature_numerator || 15.0 == initial_time_signature_numerator ||
                    22.0 == initial_time_signature_numerator || 25.0 == initial_time_signature_numerator)
                value = 1.0;
        }
