...
public class CompoundMeterFeature
    ...
    public double[] extractFeature(Sequence sequence,
        ...
        if (null != sequence_info) {
            ...
            if (6.0 == initial_time_signature_numerator || 9.0 == initial_time_signature_numerator ||
                    12.0 == initial_time_signature_numerator || 15.0 == initial_time_signature_numerator ||
                    18.0 == initial_time_signature_numerator || 24.0 == initial_time_signature_numerator)
                value = 1.0;
        }
