		...
		extends MIDIFeatureExtractor
{
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			{
				if (sequence_info.getBeat_histogram()[bin] > max)
				{
					max = sequence_info.getBeat_histogram()[bin];
					max_index = bin;
				}
			}
			...
			{
				if ( sequence_info.getBeat_histogram_thresholded_table()[bin][1] > second_highest_bin_magnitude &&
				     bin != max_index )
				{
					second_highest_bin_magnitude = sequence_info.getBeat_histogram_thresholded_table()[bin][1];
