...
public class ImportanceOfLoudestVoiceFeature
    ...
    public double[] extractFeature(Sequence sequence,
        ...
        if (null != sequence_info) {
            ...
            double loudest_average = max_so_far;
            ...
            if (2 > number_voices)
                ...
                int count = 0;
                for (int chan = 0; chan < sequence_info.channel_statistics.length; chan++) {
                    if (0 != sequence_info.channel_statistics[chan][0] && chan != loudest_chan) {
                        other_averages[count] = sequence_info.channel_statistics[chan][2];
                        count++;
                    }
                }
