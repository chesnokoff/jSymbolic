    ...
    public double[] extractFeature(Sequence sequence,
        ...
        if (null != sequence_info) {
            ...
            for (int channel = 0; 16 > channel; channel++) {
                if ((10 - 1) != channel)  // Skip over the unpitched percussion channel
                {
                            ...
                            if (!found_repeated_pitch &&
                                ...
                                for (NoteInfo following_note : notes_starting_this_following_tick) {
                                    if (current_note.getPitch() == following_note.getPitch() &&
                                            ...
                                            max_notes_that_can_go_by >= notes_gone_by_with_different_pitch) {
            ...
            if (0 == number_of_repeated_notes_found)
                value = 0.0;
            else
