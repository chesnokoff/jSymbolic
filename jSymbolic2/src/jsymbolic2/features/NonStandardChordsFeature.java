...
public class NonStandardChordsFeature implements Feature {
    ...
    public double[] extractFeature(Sequence sequence, MIDIIntermediateRepresentations sequence_info, double[][] other_feature_values) throws Exception {
        ...
        if (sequence_info != null) {
            ...
            value = chord_type_histogram[ChordTypeEnum.OTHER_TRIAD.getChordTypeCode()] + chord_type_histogram[ChordTypeEnum.DIMINISHED_TRIAD.getChordTypeCode()] + chord_type_histogram[ChordTypeEnum.AUGMENTED_TRIAD.getChordTypeCode()] + chord_type_histogram[ChordTypeEnum.OTHER_FOUR_NOTE_CHORD.getChordTypeCode()] + chord_type_histogram[ChordTypeEnum.COMPLEX_CHORD.getChordTypeCode()];
        } else
            value = -1.0;
