		...
		extends MIDIFeatureExtractor
{
	...
	throws Exception
	{
		...
		{
			double[] pitches_of_all_note_ons = new double[sequence_info.getPitches_of_all_note_ons().length];
			for (int i = 0; i < pitches_of_all_note_ons.length; i++)
				pitches_of_all_note_ons[i] = (double) sequence_info.getPitches_of_all_note_ons()[i];
