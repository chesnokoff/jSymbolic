 ...
 * @author Cory McKay
 */
public class PrevalenceOfShortRhythmicValuesFeature implements Feature {
    ...
    public String getName() {
        return "Prevalence of Short Rhythmic Values";
    }
