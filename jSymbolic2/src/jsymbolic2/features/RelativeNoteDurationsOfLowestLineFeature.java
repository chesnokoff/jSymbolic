    ...
    public double[] extractFeature(Sequence sequence,
        ...
        if (null != sequence_info) {
            ...
            for (int channel = 0; channel < channel_stats.length; channel++) {
                if (0 != channel_stats[channel][0] && (10 - 1) != channel) {
            ...
            if (0.0 == total_durations_in_lowest_channel ||
                    0.0 == total_number_notes_in_lowest_channel ||
                    0.0 == total_note_durations ||
                    0.0 == total_number_notes)
                value = 0.0;
            else {
