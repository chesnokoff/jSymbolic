    ...
    public double[] extractFeature(Sequence sequence,
        ...
        if (null != sequence_info) {
            ...
            for (int instrument = 35; 82 > instrument; instrument++) {
                if (0 != sequence_info.non_pitched_instrument_prevalence[instrument]) {
                    instruments_present++;
                }
            }
            ...
            for (int instrument = 35; 82 > instrument; instrument++) {
                if (0 != sequence_info.non_pitched_instrument_prevalence[instrument]) {
                    instrument_frequencies[count] = sequence_info.non_pitched_instrument_prevalence[instrument];
                    count++;
                }
            }
            if (null == instrument_frequencies || 0 == instrument_frequencies.length)
                value = 0.0;
            else
