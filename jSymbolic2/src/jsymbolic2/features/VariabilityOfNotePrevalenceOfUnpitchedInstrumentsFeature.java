		...
		extends MIDIFeatureExtractor
{
	...
	throws Exception
	{
		...
		if (sequence_info != null)
		{
			...
			{
				if (sequence_info.getNon_pitched_instrument_prevalence()[instrument] != 0)
				{
					instruments_present++;
				}
			}
			...
			for (int instrument = 35; instrument < 82; instrument++)
			{
				if (sequence_info.getNon_pitched_instrument_prevalence()[instrument] != 0)
				{
					instrument_frequencies[count] = (double) sequence_info.getNon_pitched_instrument_prevalence()[instrument];
					count++;
				}
			}
