...
public class VariabilityOfPartialRestDurationsFeature implements Feature {
    ...
    public String getName() {
        return "Variability of Partial Rest Durations";
    }
