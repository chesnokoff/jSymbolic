    ...
    public double[] extractFeature(Sequence sequence,
        ...
        if (null != sequence_info) {
            ...
            for (int i = 0; i < sequence_info.channel_statistics.length; i++)
                if (0 != sequence_info.channel_statistics[i][0])
                    number_with_notes++;
            ...
            for (int i = 0; i < sequence_info.note_loudnesses.length; i++) {
                if (0 < sequence_info.note_loudnesses[i].length) {
                    ...
                    for (int j = 0; j < sequence_info.note_loudnesses[i].length; j++)
                        loudnesses[j] = sequence_info.note_loudnesses[i][j];
            ...
            if (null == standard_deviations || 0 == standard_deviations.length)
                value = 0.0;
            else
