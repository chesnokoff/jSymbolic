		...
		extends MIDIFeatureExtractor
{
	...
	{
		code = "R-59";
		name = "Harmonicity of Two Strongest Rhythmic Pulses - Tempo Standardized";
		description = "Bin index of the higher (in terms of bin index) of the two tempo-standardized beat histogram peaks with the highest magnitude, divided by the index of the lower (in terms of bin index) of the two bins.";
