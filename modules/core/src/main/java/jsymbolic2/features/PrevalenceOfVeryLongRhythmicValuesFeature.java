 ...
 * @author Cory McKay
 */
public class PrevalenceOfVeryLongRhythmicValuesFeature implements Feature {
    ...
    public String getName() {
        return "Prevalence of Very Long Rhythmic Values";
    }
