...
public class SecondStrongestRhythmicPulseTempoStandardizedFeature extends Feature {
    ...
    public String getName() {
        return "Second Strongest Rhythmic Pulse - Tempo Standardized";
    }
    ...
    public String getDescription() {
        return "Bin index of the tempo-standardized beat histogram peak with the second highest magnitude.";
    }
    ...
    public double[] extractFeature(Sequence sequence, MIDIIntermediateRepresentations sequence_info, double[][] other_feature_values) throws Exception {
        ...
        if (sequence_info != null) {
            ...
            for (int bin = 0; bin < sequence_info.beat_histogram_thresholded_table_120_bpm_standardized.length; bin++) {
                if (sequence_info.beat_histogram_thresholded_table_120_bpm_standardized[bin][1] > second_highest_magnitude && bin != max_index) {
