		...
		extends MIDIFeatureExtractor
{
	...
	{
		code = "R-60";
		name = "Strength of Strongest Rhythmic Pulse - Tempo Standardized";
		description = "Magnitude of the tempo-standardized beat histogram bin with the highest magnitude.";
