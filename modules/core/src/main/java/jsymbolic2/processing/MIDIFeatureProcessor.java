...
//               saveFeatureDefinitions(window_feature_values, overall_feature_definitions[0]);
  ...
  public double[][] extractFeatures(Sequence full_sequence, MeiSequence mei_sequence) throws Exception {
/**
 * Mei Specific Storage added here
 * null is set if the file is not an mei file
 **/
    ...
    {
      throw new Exception("An error occured while processing the following file: " + ".\n");
    }
