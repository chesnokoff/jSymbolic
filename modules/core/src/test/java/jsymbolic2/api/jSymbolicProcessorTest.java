...
public class jSymbolicProcessorTest {
    ...
    private String valuesPath = "src/test/java/jsymbolic2/api/resources/feature_values.xml";
    private String definitionsPath = "src/test/java/jsymbolic2/api/resources/feature_definitions.xml";
    ...
    public void setUp() throws Exception {
        ...
        processorConfig = new JsymbolicProcessor("src/test/java/jsymbolic2/api/resources/sampleConfiguration.txt", System.out, System.err);
        processorConvert = new JsymbolicProcessor("src/test/java/jsymbolic2/api/resources/sampleConfigConvert.txt", System.out, System.err);
    }
...
//    }
    ...
    public void getJsymbolicDataDirectory() throws Exception {
        File dir = new File("src/test/java/jsymbolic2/api/resources/");
        List<String> errorLog = new ArrayList<>();
