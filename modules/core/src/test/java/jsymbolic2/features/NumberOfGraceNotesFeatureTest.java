...
import jsymbolic2.features.NumberOfGraceNotesMeiFeature;
...
public class NumberOfGraceNotesFeatureTest {
    ...
    public void setUp() throws Exception {
        saint_saens = new File("src/test/java/jsymbolic2/api/resources/Saint-Saens_LeCarnevalDesAnimmaux.mei");
