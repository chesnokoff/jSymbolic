...
public class AceToArffAndCsvTest {
    ...
    public void testConvertACEXMLtoARFF()
            throws Exception {
        String ACEname = "src/test/java/jsymbolic2/processing/resources/feature_values.xml";
        File testACE = new File(ACEname);
        String ARFFname = "src/test/java/jsymbolic2/processing/resources/feature_values.arff";
    ...
    public void testConvertARFFtoCSV() 
            throws Exception {
        String CSVname = "src/test/java/jsymbolic2/processing/resources/feature_values_noxml.csv";
        File testCSV = new File(CSVname);
        String ACEname = "src/test/java/jsymbolic2/processing/resources/feature_values.xml";
        String newCSVname = "src/test/java/jsymbolic2/processing/resources/feature_values.csv";
    ...
    public void testConvertACEtoCSVwithARFF() throws Exception {
        String CSVname = "src/test/java/jsymbolic2/processing/resources/feature_values_1.csv";
        File testCSV = new File(CSVname);
        String ACEname = "src/test/java/jsymbolic2/processing/resources/feature_values.xml";
        String newCSVname = "src/test/java/jsymbolic2/processing/resources/feature_values.csv";
        File tempCSV = new File(newCSVname);
    ...
    public void testOutputArffandCsvFormats() 
        ...
        String noXML = "src/test/java/jsymbolic2/processing/resources/feature_values_noxml";
